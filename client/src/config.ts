...
const awsVal = {
    local: {
        ...
        cognito: {
            ...
            SIGN_IN_URL: ["http://localhost:5173/", "https://dwdwwt4h4m5x8.cloudfront.net/index.html"],
            SIGN_OUT_URL: ["http://localhost:5173/", "https://dwdwwt4h4m5x8.cloudfront.net/index.html"],
        }
    },
    dev: {
        apiGateWay: {
