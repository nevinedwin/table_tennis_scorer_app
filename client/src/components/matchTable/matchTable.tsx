                    ...
                    {currentData.length ?
                        currentData.map((eachItem, index) => (
                            <tr className='border border-borderColor h-20 bg-borderColor text-white' key={index}>
                                ...
                                <td className='p-2'>
                                    <div className='w-full flex flex-col'>
                                        <div className='uppercase flex justify-start items-center gap-2'><LogoForPlayer letter={eachItem?.team1Name as string} />
                                        ...
                                        <div className='uppercase flex justify-start items-center gap-2'><LogoForPlayer letter={eachItem?.team2Name as string} />
